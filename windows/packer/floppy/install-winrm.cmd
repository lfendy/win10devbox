...
call winrm set winrm/config/winrs @{MaxMemoryPerShellMB="2000"}
@if errorlevel 1 echo ==^> WARNING: Error %ERRORLEVEL% was returned by: winrm set winrm/config/winrs @{MaxMemoryPerShellMB="2000"}
